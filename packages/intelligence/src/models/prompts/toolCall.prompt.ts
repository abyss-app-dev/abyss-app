import { RichDocumentTemplate, type ToolCallRequestPartial, type ToolCallResponsePartial } from '@abyss/records';

export const toolCallRequestPrompt = new RichDocumentTemplate<ToolCallRequestPartial>().addXMLElement((params: ToolCallRequestPartial) => ({
...
export const toolCallResponsePrompt = new RichDocumentTemplate<ToolCallResponsePromptParams>().addXMLElement(
...
export const toolUseInstructionsPrompt = new RichDocumentTemplate().addHeader2('Tool Use Instructions').addText(`
